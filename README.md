...
| **[Loom](skills/loom/)** | Persistent AI workspace memory — search decisions, log context, generate handoff summaries, and maintain project continuity across sessions and models | 🚧 v0.1.0 |
