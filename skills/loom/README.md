...
[![Phase](https://img.shields.io/badge/Phase-0.1_Foundations-27AE60.svg)](ROADMAP.md)
...
```bash
# Install from source (v0.1.0-alpha — pre-release)
...
| Phase | Name | Status |
|-------|------|:------:|
| **V0.1** | [Foundations](docs/product-evolution.md#v01--foundations) — Resume + Memory + Doctor | 🚧 In Progress |
| **V0.2** | [Sequential Handoff](docs/product-evolution.md#v02--sequential-model-handoff) — Cross-model context transfer | ⬜ Planned |
| **V0.3** | [Controlled Gateway](docs/product-evolution.md#v03--controlled-gateway--remote-access) — Remote MCP + policy engine | ⬜ Planned |
| **V0.4** | [Memory Hardening](docs/product-evolution.md#v04--memory--recovery-hardening) — Recovery + vector search | ⬜ Planned |
| **V1.0** | [Stable Substrate](docs/product-evolution.md#v10--stable-technical-substrate) — Frozen contracts + hybrid topology | ⬜ Planned |
