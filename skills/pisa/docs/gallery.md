...
Visual catalog of every canvas available in the PISA registry. Each canvas is a reusable slide structure that gets filled with your content, styled by your theme, and shaped by your persona.

> These are SVG previews rendered by the PISA engine. In Claude, say `"Show me all KPI canvases"` to browse interactively.

---

## Corporate Essentials — 24 canvases
...
## Strategy Consulting — 12 canvases
...
A canvas defines **structure** — intent, layout, component positions, visual treatment. Three things transform it at runtime:
...
Same canvas + different theme = different look. Same canvas + different persona = different density. Same canvas + different content = different deck.
