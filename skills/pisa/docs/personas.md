...
A persona controls **how** the deck communicates. It is not a theme (colors/fonts) — it is a generation strategy that affects canvas selection, density limits, title style, narrative framework, and visual ratio.
